...
from nebula import Nebula  # noqa: I001


def main():
    # Replace with your API key
    api_key = (
        "key_8dLIxbjdJJcayoNemQcYGA==.b7JUWoaRebqmlSnFZylEYmMInaOoIgiuL3vjView5A8="
    )
    ...
    for i, result in enumerate(results, 1):
        print(
            f"  {i}. {result.metadata.get('title', 'No title')} (Cluster: {result.collection_id})"
        )
