...
exports.conversationExample = conversationExample;
exports.advancedSearchExample = advancedSearchExample;
const index_1 = require("../src/index");
// Example: Basic memory management with Nebula SDK
async function basicExample() {
    // Initialize the SDK
    const client = new index_1.NebulaClient({
    ...
    try {
        ...
        console.log('✅ Cluster created:', cluster.name, 'with ID:', cluster.id);
